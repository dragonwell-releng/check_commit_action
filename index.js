...
function check_last_n_revisions(nof_revs, ref) {
    console.log("checking last " + nof_revs + " revisions on " + ref);
    ...
    git.rev_list({ pretty: 'raw', max_count: nof_revs },
        ref,
...
try {
    ...
    if (github.context.eventName === 'pull_request') {
        ...
        check_last_n_revisions(1, github.context.ref);
    } else {
